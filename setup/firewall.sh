...
#
# HTTP zu debian server erlauben fuer updates
#
iptables -A OUTPUT -p tcp --dport 80 -d 141.76.2.4 -j ACCEPT
iptables -A OUTPUT -p tcp --dport 80 -d 195.20.242.89 -j ACCEPT
iptables -A OUTPUT -p tcp --dport 80 -d 212.211.132.250 -j ACCEPT
iptables -A OUTPUT -p tcp --dport 80 -d 212.211.132.32 -j ACCEPT
#
